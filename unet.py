...
class Unet(object):
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        if self.mix_type == 0:
            ...
            _, binary_img = cv2.threshold(crop_image, 127, 255, cv2.THRESH_BINARY)  # 使用INV因为细胞是亮的
            ...
            for cnt in contours:  
                ...
                if M["m00"] != 0:  
                    ...
                    # 在PIL图像上绘制重心（使用PIL的坐标系统，即左上角为原点）
                    color = (255, 0, 0)  # 红色   
                    draw.ellipse([cX-2, cY-2, cX+2, cY+2], outline='red')  # 注意这里我们使用outline而不是fill  
